...
const char *ssid = "iTN - FORGE/s";
const char *password = "ForgeXForged";
const char *device_token = "51621ee2488edb16";  //same as if you use XAMPP then on this and off that
//************************************************************************
String getData, Link;
String URL = "http://192.168.0.101/attendance/getdata.php";  //if i use XAMPP in windows then on this and off that
//************************************************************************
